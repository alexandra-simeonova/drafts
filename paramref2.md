...
- [Navigation parameters reference](#navigation-parameters-reference)
  * [Routing parameters](#routing-parameters)
    + [useHashRouting](#usehashrouting)
    + [nodeParamPrefix](#nodeparamprefix)
    + [skipRoutingForUrlPatterns](#skiproutingforurlpatterns)
  ...
  * [Navigation parameters](#navigation-parameters)
    ...
    + [viewGroupsSettings](#viewgroupssettings)
  * [Node parameters](#node-parameters)
    ...
    + [context](#context)
    + [defaultChildNode](#defaultchildnode)
    + [isolateView](#isolateview)
    + [viewGroup](#viewgroup)
    + [keepSelectedForChildren](#keepselectedforchildren)
    + [loadingIndicator.enabled](#loadingindicatorenabled)
    + [loadingIndicator.hideAutomatically](#loadingindicatorhideautomatically)
    + [icon](#icon)
    + [hideSideNav](#hidesidenav)
    + [badgeCounter](#badgecounter)
    + [category](#category)
    + [opeNodeInModal](#openodeinmodal)
    + [onNodeActivation](#onnodeactivation)
    + [clientPermissions.changeCurrentLocale](#clientpermissionschangecurrentlocale)
  * [Context switcher](#context-switcher)
    ...
    + [options](#options)
    + [actions](#actions)
    + [fallbackLabelResolver](#fallbacklabelresolver)
    + [preserveSubPathOnSwitch](#preservesubpathonswitch)
  * [Profile](#profile)
    + [logout](#logout)
    + [items](#items)
  ...
  * [App switcher](#app-switcher)
    + [showMainAppEntry](#showmainappentry)
    + [items](#items-2)
