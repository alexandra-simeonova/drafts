...
* [Navigation configuration example](navigation-parameters-referece#navigation-configuration-example.md)
* [Routing](navigation-parameters-referece#routing.md)
* [Node navigation parameters](node-navigation-parameters.md)
* [Node parameters](navigation-parameters-referece#node-parameters.md)
* [Profile](navigation-parameters-referece#profile.md) 
* [Context switcher](navigation-parameters-referece#context-switcher.md)
* [Product switcher](navigation-parameters-referece#product-switcher.md)
* [App switcher](navigation-parameters-referece#app-switcher.md)

## Navigation configuration example

This code sample demonstrates a sample structure with many of the parameters you can use when configuring navigation for Luigi. 
...
defines either hash-based (`url.com/#/yourpath`) or path-based (`url.com/yourpath`) routing.
</details>
</div> 
...
Node parameters can be used to customize your navigation structure and the individual nodes within it. 
